...
namespace nilnul._bit_._TEST_.op_.of_.vec.set.be_.complete_.byCompoFunc_.ofVec.projectionIni_.allVecs
{
	[TestClass]
	public class UnitTest1
	{
		...
		void assertCompletes()
		{
			var completes = new nilnul.bit.OpI2[][] {
				...
				,
				new bit.OpI2[]{
					bit.op_.binary_.Imply.Singleton
					,
					bit.op_.binary_.Xor.Singleton
				}
				,
